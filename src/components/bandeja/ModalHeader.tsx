...
const ESTADO_STYLE: Record<SolicitudEstado, { border: string; badge: string }> = {
    valida_1: { border: "border-l-cyan-500", badge: "bg-cyan-100 text-cyan-700 border-cyan-200" },
    no_valida_1: { border: "border-l-red-500", badge: "bg-red-100 text-red-700 border-red-200" },
    val_identidad: { border: "border-l-sky-500", badge: "bg-sky-100 text-sky-700 border-sky-200" },
    no_val_identidad: { border: "border-l-red-500", badge: "bg-red-100 text-red-700 border-red-200" },
    fallo_servicios: { border: "border-l-purple-500", badge: "bg-purple-100 text-purple-700 border-purple-200" },
    ...
    contabilizado: { border: "border-l-emerald-600", badge: "bg-emerald-100 text-emerald-700 border-emerald-200" },
    revision: { border: "border-l-amber-400", badge: "bg-amber-100 text-amber-700 border-amber-200" },
};
